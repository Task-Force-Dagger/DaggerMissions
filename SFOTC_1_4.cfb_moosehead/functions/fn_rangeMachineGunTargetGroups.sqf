 ...
 *
 * Example:
 * [this] call TFD_Olympus_fnc_rangeMachineGunTargetGroups
 */
...
{
    [_x, 1] call TFDFUNC(shootingrange,animateTarget);
} forEach [ALL_TARGETS];
//////////////
...

{
    ...
    private _action = [
        ...
        "x\cba\addons\ai\iconinvisibletarget.paa",
        {
            ...
            {
                [_x, _state] call TFDFUNC(shootingrange,animateTarget);
                _x setVariable [QTFDGVAR(shootingrange,stayDown), true, true];
