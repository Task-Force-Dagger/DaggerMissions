 ...
 *
 * Example:
 * [controller, stretcher, bodyPart] call TFD_Olympus_Medical_fnc_specific_projectileTypeActions
 */
...
private _actions = [];
{
    ...
    private _projectileTypeAction = [
        ...
        {},
        {true},
        {(_this select 2) call TFD_Olympus_Medical_fnc_specific_severityActions},
