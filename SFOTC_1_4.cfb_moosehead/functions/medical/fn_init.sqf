 ...
 *
 * Example:
 * [controller, medicalSpawnPos] call TFD_Olympus_Medical_fnc_init
 */
...

{
    ...
    [_controller, _spawnPos, _stretcher, _subjectName] call TFD_Olympus_Medical_fnc_createSubject;
} forEach _stretchers;
...
{
    _x params ["_stretcher", "_subjectName"];
    [_controller, _stretcher, _subjectName] call TFD_Olympus_Medical_fnc_removeSubject;
} forEach _stretchers;
...

{
    ...
    private _specificDamageAction = [
        ...
        {},
        {
            ...
            [_stretcher] call TFD_Olympus_Medical_fnc_checkSubject
        },
        {(_this select 2) call TFD_Olympus_Medical_fnc_specific_bodyPartActions},
...

{
    ...
    private _randomDamageAction = [
        ...
        {(_this select 2) call TFD_Olympus_Medical_fnc_applyRandomDamage},
        [_controller, _stretcher]
    ] call ACEFUNC(interact_menu,createAction);
...
private _instructorDisplayOpen = [
    ...
    {(_this select 2) call TFD_Olympus_Medical_fnc_instructorDisplay},
